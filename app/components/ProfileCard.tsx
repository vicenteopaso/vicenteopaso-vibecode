...
const socialIconClasses =
  "btn-outline h-8 w-8 p-0 text-[color:var(--text-primary)] hover:border-[color:var(--link-hover)] hover:text-[color:var(--link-hover)]";
              ...
              <div className={linksRowClasses}>
                ...
                {!isCvHeader && (
                  <div className="flex w-full items-center gap-3 sm:hidden">
                    <Link
                      href={`/${locale}/cv`}
                      className="btn-primary flex-1 no-underline hover:!no-underline"
                    >
                      {t("cv.readLabel")}
                    </Link>
                    <a
                      ...
                      >
                        {sectionLinks.map((link, idx) => (
                          ...
                          >
                            ...
                            <a
                              href={link.href}
                              className="text-[color:var(--link)] no-underline hover:text-[color:var(--link-hover)] hover:underline hover:decoration-2 underline-offset-4"
                            >
                              {link.label}
                            </a>
                          </span>
