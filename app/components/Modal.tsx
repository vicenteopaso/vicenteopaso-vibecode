  ...
  return (
    ...
    >
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={`${getSizeClasses(size)} fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[85vh] overflow-y-auto overscroll-contain rounded-2xl border border-[color:var(--border-strong)] bg-[color:var(--bg-surface)]/95 p-6 text-sm text-[color:var(--text-primary)] shadow-[0_18px_60px_rgba(15,23,42,0.9)] outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent)]/60`}
        >
          {children}
        </Dialog.Content>
      </Dialog.Portal>
