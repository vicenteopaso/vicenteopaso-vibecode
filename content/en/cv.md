...
"highlights": [
"Modernized frontend stack used by 5,000+ aviation stakeholders across Europe.",
"Reduced page payloads by 40%, improving load times in low-bandwidth regions.",
"Re-architected legacy flows into modular components, reducing maintenance overhead by 30%.",
...
"highlights": [
"Defined component architecture powering multiple brand sites across Western Europe.",
"Established DevEx workflows reducing onboarding time for new engineers by 50%.",
"Introduced accessibility frameworks ensuring AA baseline across products.",
...
"references": [
{
"name": "<a href='https://www.linkedin.com/in/carvido1'>Carlos Vicent Domenech</a> | Site Reliability Engineer Lead @ Nexthink",
"reference": "I have had the chance to work twice in different companies with Vicente. On our first journey, working for Carlsberg, we were in two different teams responsible for different products/platforms. Vicente was responsible for the team handling the design and framework of the platform to onboard new markets for Carlaberg. They created Carlsberg Malty, an open-source design system to standarise components to be used in the different store-fronts and markets. As we travelled to Lisbon regularly to meet our colleagues in the Carlsberg Digital Hub, we always had time to chat and discuss technology in endless evenings and nights. These discussions opened us to understand different technical points of view and improved the understanding of the ongoing work from the different groups.<br /><br />On our second journey, Vicente joined Nexthink as Web Engineering Manager. Despite the short period working with Vicente again, we retook conversations, going more into engineering management, key decisions and pain points in fast-growing teams. This indicates to me that leadership and the desire to excel at work are still strong skills Vicente possesses.<br /><br />I'm reassuring my confidence with Vicente and his skills to lead the creation of platforms that improve the Developer Experience and accelerate the development and delivery of tangible products."
},
{
